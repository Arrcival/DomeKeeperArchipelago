...
func generate():
	...
	var switchCoordinates = generateSwitchesCoordinates(tdResources, cells, GameWorld.archipelago.switchesPerLAyer)
...
func generateSwitchesCoordinates(tdResources, cells: Array, switchesPerLayer: Array) -> Array:
